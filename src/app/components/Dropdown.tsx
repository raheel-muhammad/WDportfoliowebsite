        ...
        <div className="relative inline-block text-left">
            <div>
                <button
                    ...
                    className="inline-flex justify-between items-center bg-[#8700E810]  border-[1px] border-[#2A0049]  text-[#ffffff60] w-full h-[50px] rounded-[8px] pl-[25px] font-[500] text-[16px] tracking-[2%] leading-[24px] pr-[25px]"
                    id="menu-button"
