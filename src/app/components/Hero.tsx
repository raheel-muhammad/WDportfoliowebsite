...
const Hero = () => {
    return (
        <>
            <div className='sm:pt-[30px] pt-[20px] sm:px-[40px] px-[15px] relative'>
                <Header />
            </div>
            <div className="flex flex-col justify-center items-center">
                <div className=' lg:w-[194px] md:w-[194px] sm:w-[120px] w-[120px] sm:h-[24px] h-[24px] lg:h-[39px] md:h-[39px] flex justify-center items-center rounded-[8px] border-[1px] border-[#7000C0] gap-[10px]  sm:mt-[82px] mt-[82px] lg:mt-[180px] lg:mb-[40px] md:mb-[40px] sm:mb-[25px] mb-[25px] bg-background ' >
                    <p className=' font-[500] md:text-[20px] lg:text-[20px] sm:text-[12px] text-[12px]'>We Glow You</p>
                </div>
                <div className='flex flex-col justify-center items-center mb-[40px] sm:mb-[40px] md:[74px] lg:mb-[74px] '>
                    <p className="font-[700] lg:text-[60px] md:text-[40px] sm:text-[24px] text-[24px] text-center">
