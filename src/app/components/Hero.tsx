        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className='flex flex-col justify-center items-center mb-[40px] sm:mb-[40px] md:[74px] lg:mb-[74px] '>
                    <p className="font-[700] lg:text-[60px] md:text-[40px] sm:text-[24px] text-[24px] text-center tracking-[2%] leading-[36px] md:tracking-[2%] md:leading-[60px] lg:tracking-[2%] lg:leading-[80px]">
