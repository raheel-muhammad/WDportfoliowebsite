    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='pt-[62px] lg:pl-[80px] md:pl-[80px] sm:pl-[0px] flex flex-col flex-grow'>
                ...
                <div className='flex lg:justify-end justify-center md:justify-end sm:justify-center lg:pr-[35px] pr-[0px] md:pr-[35px]  sm:pt-[40px] md:pt-0 lg:pt-[0px] pt-[50px] cursor-pointer'>
