...
const Contact = () => {
    return (
        <>
            ...
            <div className='flex md:flex-row flex-col items-center justify-center mt-[0px] md:mt-[156px] mx-[10px] sm:mx-[72px] md:ml-[30px] md:mr-[140px]'>
                ...
                <div className='rounded-[15px] flex justify-center items-center gradient-border bg-[#8700E805] w-full md:w-1/2 flex-col gap-[30px] px-[15px] py-[40px] md:py-[80px] md:px-[60px]'>
                    ...
                    <textarea
                        name="text"
                        className="bg-[#8700E810] border-[1px] border-[#2A0049] placeholder-[#ffffff60] block h-[149px] w-full rounded-[8px] pl-[30px] pr-[30px] pt-[13px] font-[500] text-[16px] tracking-[2%] leading-[24px] resize-none"
                        placeholder="Your Idea"
                    />

                    <button className='max-w-[200px] w-full h-[40px] rounded-[20px] grad-border bg-submit text-center items-center justify-center flex tracking-[2%] leading-[24px]'>
                        Submit
                    </button>
